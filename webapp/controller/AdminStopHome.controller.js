sap.ui.define([
     ...
     */
    function (Controller, Dialog, Button, Text, DialogType, MessageBox,JSONModel) {
        "use strict";
        var oStopId = "";
        var intent = "create";
        return Controller.extend("adminbusbooking.controller.AdminStopHome", {
            ...
            resetJsonModel: function () {
                //set null data
                var jsonModel = this.getView().getModel("adminStop");
                var oData = {
                    StopId: "",
                    Name: "",
                    City: "",
            ...
            saveStopData: function () {
                ...
                oData["Validtill"]=oData["Validtill"]+"T00:00:00"
            ...
            onEditClick: function (evt) {
                intent = "edit"
                var jsonModel = this.getOwnerComponent().getModel('adminStop')   ///doubt here
